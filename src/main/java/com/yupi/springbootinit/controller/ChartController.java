...
public class ChartController {
    ...
    private ChartTaskStatusVO buildTaskStatusVO(Chart chart, Chart succeedContentChart) {
        ...
        vo.setStatusText(ChartTaskStatusViewUtils.resolveStatusText(chart.getStatus()));
        String taskPhase = ChartTaskTraceUtils.resolveTaskPhase(chart.getStatus(), chart.getExecMessage());
        vo.setTaskPhase(taskPhase);
        vo.setTraceId(ChartTaskTraceUtils.buildTraceId(chart.getId()));
        vo.setShouldPoll(ChartTaskStatusViewUtils.shouldPoll(chart.getStatus()));
        vo.setTerminal(ChartTaskStatusViewUtils.isTerminal(chart.getStatus()));
        vo.setProgress(ChartTaskStatusViewUtils.resolveProgress(chart.getStatus(), taskPhase));
